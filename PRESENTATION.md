...
→ IDENTIFIER ASSIGN factor PLUS factor
→ IDENTIFIER ASSIGN factor PLUS 3
→ IDENTIFIER ASSIGN 5 PLUS 3
→ x ASSIGN 5 PLUS 3
```
...
- `INTEGER comparison INTEGER → BOOLEAN`
- `not BOOLEAN → BOOLEAN`
...
- 📘 **INTERACTIVE_GUIDE.md** - Complete REPL guide (295 lines)
- 📘 **QUICK_START.md** - Quick start tutorial (216 lines)
- 📘 **TROUBLESHOOTING.md** - Debug assistance
- 📘 **docs/grammar.md** - Complete CFG specification
...
**Output:**
- Token list → `output/test2_tokens.txt`
- AST structure → `output/test2_ast.txt`
- Symbol table → `output/test2_symbols.txt`
- Generated code → `output/test2_code.txt`
...
│   ├── lexer.py          (288 lines)
│   ├── parser.py         (515 lines)
│   ├── semantic.py       (466 lines)
│   ├── codegen.py        (384 lines)
│   ├── symbol_table.py   (245 lines)
│   ├── ast_nodes.py      (424 lines)
│   ├── tokens.py         (124 lines)
│   ├── compiler.py       (376 lines)
│   └── interactive.py    (255 lines)
├── examples/
│   ├── test1.py          (43 lines)
│   ├── test2.py          (78 lines)
│   └── test3.py          (100 lines)
├── docs/
│   └── grammar.md        (147 lines)
├── README.md
...
if_stmt         → IF expression COLON NEWLINE INDENT 
...
while_stmt      → WHILE expression COLON NEWLINE INDENT 
                  statement_list DEDENT
